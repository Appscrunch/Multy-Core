 ...
 */
WALLET_CORE_API Error* make_mnemonic(EntropySource entropy_source, const char ** mnemonic);
 ...
 */
WALLET_CORE_API Error* make_seed(const char* mnemonic, const char* password, BinaryData** seed);
